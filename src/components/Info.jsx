...
const Info = () => {
    return (
        <div className="w-[95vw] mx-auto my-24 flex flex-col md:flex-row gap-8">
            {/* Details Section */}
            <div className="w-[95%] mx-auto details flex flex-col gap-8 md:gap-16 md:basis-1/3">
                {/* See Button */}
                <div className="see_btn flex gap-4 items-center">
                ...
                <div className="features flex flex-wrap gap-4">
                    <span className="border border-white w-max rounded-[30px] px-4 py-2 hover:cursor-pointer hover:bg-slate-700 text-sm md:text-base">
                        Web Analytics
                    </span>
                    <span className="border border-white w-max rounded-[30px] px-4 py-2 hover:cursor-pointer hover:bg-slate-700 text-sm md:text-base">
                        Email Marketing
